    ...
    <div className="space-y-16">
      ...
      >
        ...
        <p className="text-sm max-w-md mx-auto leading-relaxed" style={{ color: "var(--text-secondary)" }}>
          Select 2 or 3 vacuums and compare them side by side — key facts, specs, buyer patterns, and the expert take.
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: SITE_NAME,
            url: SITE_URL,
            description: "Structured vacuum product intelligence — expert Briefs, comparisons, and roundups.",
          }),
        }}
      />
    </div>
